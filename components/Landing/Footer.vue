  ...
  <footer class="bg-primary-950 text-white mt-20 py-20">
    <div class=" w-full lg:max-w-[80%] mx-auto px-4 text-white">
        ...
        <div class="content flex flex-col lg:flex-row justify-between items-center">
            ...
            <div class="s flex justify-between lg:gap-16 my-8 lg:my-0">
                <div class="company">
                    <h2 class="text-2xl lg:text-3xl font-bold pb-6">Company</h2>
                ...
                <div class="_connect">
                    <h2 class="text-2xl lg:text-3xl font-bold pb-6">Connect</h2>
                    <div class="flex flex-col space-y-6">
