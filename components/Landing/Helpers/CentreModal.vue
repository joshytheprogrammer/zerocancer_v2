<template>
  <GlobalHelpersModal @closeModal="$emit('closeCentreModal')">
    ...
    <template #body>
      <div id="cardContainer" class="flex flex-col justify-start">  
        ...
        <template v-for="centre in centres" :key="centre.id">
          ...
          <div class="card border shadow-[0_0_10px_rgba(0,0,0,0.1)] mx-0 my-4 p-4 rounded-lg border-solid border-[rgba(0,0,0,0.1)]">
            ...
            <div class="px-0 py-3">
              <p class="text-lg">{{centre.name}} is located here</p>
              <p class=" font-bold flex justify-start items-center gap-1">
                ...
                <a class=" underline text-primary-800 inline-flex items-center gap-1" :href="centre.mapsLink" target="_blank">
            ...
            <div class="px-0 py-3">
              <p class="text-lg">For inquiries</p>
              <p class=" font-bold flex justify-start items-center gap-1">
            ...
            <a class=" bg-primary-600 text-white block w-fit cursor-pointer mx-0 my-4 px-8 py-4 rounded-xl border" :href="centre.formLink" >{{centre.isSeller ? 'Schedule a Purchase' : 'Schedule an appointment'}}</a>
          </div>
        </template>
      </div>
