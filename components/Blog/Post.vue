...
<style lang="postcss">
.post h1 {
  @apply font-bold text-4xl my-4 text-primary-950;
}
...
.post blockquote {
  @apply m-4 p-2 border-l-4 border-gray-300 italic;
}
...
.post pre {
  @apply bg-gray-100 p-4 font-mono text-sm;
}
...
.post thead th {
  @apply bg-gray-100 font-bold text-base;
}
