<template>
  <div class="block w-full lg:max-w-[80%] mx-auto my-4 lg:my-20 px-4 lg:px-0">
    ...
    <TermsHelpersBody>
      <div>
        ...
        <p>This privacy notice for ZeroCancer (doing business as Zerocancer) ('we', 'us', or 'our'), describes how and why we might collect, store, use, and/or share ('process') your information when you use our services ('Services'), such as when you:</p>
        <ul>
            <li>Visit our website at <a href="https://zerocancer.africa/">https://zerocancer.africa/</a>, or any website of ours that links to this privacy notice</li>
            <li>Engage with us in other related ways, including any sales, marketing, or events</li>
        </ul>

        <p>Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:privacy@zerocancer.africa">privacy@zerocancer.africa</a>.</p>
        ...
        <ol>
            <li><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. <a href="#personal_information">Learn more about personal information you disclose to us.</a></li>
            <li><strong>Do we process any sensitive personal information?</strong> We do not process sensitive personal information.</li>
            <li><strong>Do we receive any information from third parties?</strong> We may receive information from public databases, marketing partners, social media platforms, and other outside sources. <a href="#third_party_information">Learn more about information collected from other sources.</a></li>
            <li><strong>How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. <a href="#processing_information">Learn more about how we process your information.</a></li>
            <li><strong>In what situations and with which parties do we share personal information?</strong> We may share information in specific situations and with specific third parties. <a href="#sharing_information">Learn more about when and with whom we share your personal information.</a></li>
            <li><strong>How do we keep your information safe?</strong> We have organisational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorised third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. <a href="#security_information">Learn more about how we keep your information safe.</a></li>
            <li><strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. <a href="#privacy_rights">Learn more about your privacy rights.</a></li>
        ...
        <ol>
            <li><a href="#what_information">WHAT INFORMATION DO WE COLLECT?</a></li>
            <li><a href="#how_process">HOW DO WE PROCESS YOUR INFORMATION?</a></li>
            <li><a href="#legal_bases">WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</a></li>
            <li><a href="#share_information">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a></li>
            <li><a href="#third_party">WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</a></li>
            <li><a href="#cookies_tracking">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
            <li><a href="#social_logins">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a></li>
            <li><a href="#information_retention">HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
            <li><a href="#keep_safe">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
            <li><a href="#minors">DO WE COLLECT INFORMATION FROM MINORS?</a></li>
            <li><a href="#privacy_rights">WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
            <li><a href="#do_not_track">CONTROLS FOR DO-NOT-TRACK FEATURES</a></li>
            <li><a href="#updates_notice">DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
            <li><a href="#contact_notice">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
            <li><a href="#review_update_delete">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></li>
        </ol>
        <h2 id="what_information">WHAT INFORMATION DO WE COLLECT?</h2>
        ...
        <p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is stored by Paystack. You may find their privacy notice link(s) <a href="https://paystack.com/terms">here</a>.</p>
        ...
        <p><em>In Short:</em> We may collect limited data from public databases, marketing partners, social media platforms, and other outside sources.</p>
        ...
        <h2 id="how_process">HOW DO WE PROCESS YOUR INFORMATION?</h2>
        ...
        <h2 id="legal_bases">WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
        ...
        <h3 id="share_information">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h3>
        ...
        <h3 id="third_party">WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h3>

        <p><em>In Short:</em> We are not responsible for the safety of any information that you share with third parties that we may link to or who advertise on our Services, but are not affiliated with, our Services.</p>
        ...
        <h3 id="cookies_tracking">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h3>
        ...
        <h3 id="social_logins">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h3>

        <p><em>In Short:</em> If you choose to register or log in to our Services using a social media account, we may have access to certain information about you.</p>
        ...
        <h3 id="information_retention">HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
        ...
        <h3 id="keep_safe">HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
        ...
        <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at <a href="mailto:admin@zerocancer.africa">admin@zerocancer.africa</a>.</p>

        <h3 id="privacy_rights">WHAT ARE YOUR PRIVACY RIGHTS?</h3>

        <p><em>In Short:</em> In some regions, such as the European Economic Area (EEA), United Kingdom (UK), Switzerland, and Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</p>
        ...
        <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:privacy@zerocancer.africa">privacy@zerocancer.africa</a>.</p>

        <h3 id="do_not_track">CONTROLS FOR DO-NOT-TRACK FEATURES</h3>
        ...
        <h3 id="updates_notice">DO WE MAKE UPDATES TO THIS NOTICE?</h3>
        ...
        <h3 id="contact_notice">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h3>

        <p>If you have questions or comments about this notice, you may email us at <a href="mailto:admin@zerocancer.africa">admin@zerocancer.africa</a> or contact us by post at:</p>
        ...
        <h3 id="review_update_delete">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
